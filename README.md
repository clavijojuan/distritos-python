# Titulo de la Solución X / Prueba de concepto X
...
[Otros documentos](**Arquitectura de Solución)
...
**Nota:** Obligatorio: Minimo debe tener una descripcion de la solucion con los objetivos establecidos con el negocio o área del ministerio y los entregables esperados.

### Reto del cliente
**Nota:** Puede poner cúal es el reto que el cliente tiene y se quiere resolver
### Solución 
**Nota:** Puede poner la solución propuesta desde el equipo
...
-- Se recomienda utilizar del siguiente comando y su uso dependera de su Sistema Operativo:
...
Paso 2
docker run -d --name boilerplate-fastapi -p 8000:8000 boilerplate-fastapi
...
|----------|-------------|-------------|
| OTIC |  Persona 1: Científico de Datos | ejemplo@XXXX |
| Bosques  |  Persona 2: Líder del negocio  | ejemplo@XXXX |
